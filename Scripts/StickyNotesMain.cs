...
namespace StickyNotes
{
    public class StickyNotesMain : MonoBehaviour, PlacenoteListener
    {
        ...
        void Start()
        {
            ...
            //SceneManager.MergeScenes(SceneManager.GetSceneByName("StickyNotes"),SceneManager.GetSceneByName("VuforiaScene"));
        }
        ...
        */
        ...
        public void OnLoadMapClick()
        {
            ...
            LibPlacenote.Instance.SearchMaps("Note:", (mapList) =>
            {
                ...
                // Render the map list!
                mSelectedMapInfo = mapList[mapList.Length - 1];
            ...
            //SceneManager.LoadScene("VuforiaScene", LoadSceneMode.Additive);
        }
        ...
        {
            mLabelText.text = "Localized. Enjoy our AR guide!";
            Debug.Log("load localized");
            //Debug.Log(mSelectedMapInfo.metadata.userdata.ToString());
